...
> FormerChampion (QWS-0801 CLOSED).
...
### [CURRENT — QWS-0801] — FormerChampion

| Node | Story | Role |
|---|---|---|
| `FormerChampion` | QWS-0801 | Decay watch: demoted Champion under observation; sits between Champion and RetiredChampion. Created by `qw degrade`. |
...
### [CURRENT — QWS-0801] — FormerChampion edges
...
| `former_champions` | QWS-0801 | Cemetery view: FormerChampion nodes with `oos_reason`, `retirement_note`, and lifecycle `status` (DEGRADED \| RETIRED). Use before proposing a strategy. |
...
retirement. `retirement_note` is on `RetiredChampion` (optional free-text). Both implemented in QWS-0801.
