...
### Tier 1 — Databento GLBX.MDP3 (5yr, 11 timeframes)

| Symbol | Description | Range |
|--------|-------------|-------|
| ES | S&P 500 | 2021-04-14 → current |
| NQ | Nasdaq 100 | 2021-04-14 → current |
| CL | Crude Oil WTI | 2021-04-14 → current |
| GC | Gold | 2021-04-14 → current |
| ZN | 10yr Treasury Note | 2021-04-14 → current |
| RTY | Russell 2000 | 2021-04-14 → current |
| 6E | Euro FX | 2021-04-14 → current |
| NG | Natural Gas | 2021-04-14 → current |
| ZB | 30yr Treasury Bond | 2021-04-14 → current |
| SI | Silver | 2021-04-14 → current |
| HG | Copper | 2021-04-14 → current |
| 6J | Japanese Yen | 2021-04-14 → current |
| 6B | British Pound | 2021-04-14 → current |
...
Covers: 2019 low-vol bull, 2020 COVID crash + V-recovery, 2021 bull, 2022 rate hike cycle, 2023-2024 normalization, 2025-2026 current regime.
...
| USDA NASS | Corn + soybean crop progress, 5 states + national (weekly, seasonal) | 2021+ |
| Google Trends | buy gold, gold inflation hedge, recession, inflation (weekly) | 2021+ |
...
| Treasury rates | FMP full curve (weekly) | 2021+ |
| BDTI | Baltic Dirty Tanker Index (daily) | 2016+ |
| Economic calendar | FOMC, NFP, CPI, etc. (`calendar` lib) | rolling 5 weeks |
