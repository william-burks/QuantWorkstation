...
| Trial Engineer Agent | QWS-1303 (**TESTING**) | `trial-engineer` agent; generates trial script + bundle.json from hypothesis context; stops before run | ~~QWS-1302~~ |
...
| Trial Engineer Agent | QWS-1303 (**TESTING**) | Agent that drafts and runs trial scripts — see Epic 13 | Epic 13 |
