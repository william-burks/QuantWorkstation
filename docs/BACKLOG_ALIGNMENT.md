...
| Champion Degradation Advisory | QWS-1405 (**TESTING**) | `qw monitor --audit-lineage`; advisory output for lineage-rejected Champions; `qw degrade --reason`; `degrade_reason` on FormerChampion | — |
