...
| Regime Diversity Gate | QWS-1402 (**TESTING**) | `diversity_score()` in metrics.py; diversity block in evaluator.report(); `diversity_score`, `diversity_years_positive`, `diversity_distinct_years` in `trial_metadata` on Run node | ~~QWS-1401~~ |
