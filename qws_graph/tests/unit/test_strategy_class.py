...
def test_portfolio_by_class_no_required_params() -> None:
    ...
    from qws_graph.research.graph.query_presets import validate_params
...
def test_portfolio_by_class_cypher_constant() -> None:
    ...
    from qws_graph.research.graph.cypher import PORTFOLIO_BY_CLASS_CYPHER
...
def test_patch_strategy_class_cypher_constant() -> None:
    ...
    from qws_graph.research.graph.cypher import PATCH_STRATEGY_CLASS_QUERY
...
def test_get_unclassified_strategies_cypher_constant() -> None:
    ...
    from qws_graph.research.graph.cypher import GET_UNCLASSIFIED_STRATEGIES_QUERY
...
def test_data_dictionary_contains_strategy_class() -> None:
    ...
    yaml_path = Path(__file__).parents[2] / "docs" / "data_dictionary.yaml"
