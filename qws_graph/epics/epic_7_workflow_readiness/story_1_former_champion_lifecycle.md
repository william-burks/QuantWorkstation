...
### AC1: qw degrade creates FormerChampion node and exits 0
- type: cli
- cmd: `python -m research.graph.cli degrade demo_champ_001 --reason "MaxDD breached -15% in CPI spike"`
- expect_contains: "OK"
- expect_exit: 0

### AC2: qw degrade without --reason exits non-zero
- type: cli
- cmd: `python -m research.graph.cli degrade demo_champ_001`
- expect_contains: "error"
- expect_exit: 2

### AC3: qw degrade with empty --reason exits non-zero
- type: cli
- cmd: `python -m research.graph.cli degrade demo_champ_001 --reason ""`
- expect_contains: "ERROR"
- expect_exit: 1

### AC4: qw degrade with non-existent id exits non-zero
- type: cli
- cmd: `python -m research.graph.cli degrade nonexistent_id --reason "test reason"`
- expect_contains: "ERROR"
- expect_exit: 1

### AC5: qw retire creates RetiredChampion and exits 0
- type: cli
- cmd: `python -m research.graph.cli retire demo_former_champ_001 --note "Logic dead-ended"`
- expect_contains: "OK"
- expect_exit: 0

### AC6: qw retire stores retirement_note
- type: cypher
- cmd: `MATCH (fc:FormerChampion {former_champion_id: 'demo_former_champ_001'})-[:RETIRED_TO]->(rc:RetiredChampion) RETURN rc.retirement_note AS note`
- expect_contains: "Logic dead-ended"

### AC7: qw retire without --note succeeds
- type: cli
- cmd: `python -m research.graph.cli retire demo_former_champ_001`
- expect_contains: "OK"
- expect_exit: 0
...
- expect_contains: "demo_former_champ_001"
- expect_exit: 0

### AC9: Champion remains readable after demotion
- type: cypher
