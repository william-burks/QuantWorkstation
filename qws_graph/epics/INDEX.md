...
14. **Epic 13 — Agent Design** — `CLOSED` (QWS-1301 CLOSED; QWS-1302 CLOSED)
...
- `QWS-1005` `epic_10_macro_data[COMPLETE]/story_noaa_degree_days.md` — `CLOSED` (out-of-scope instrument, never attempted)
- `QWS-1006` `epic_10_macro_data[COMPLETE]/story_usda_crop_progress.md` — `CLOSED` (out-of-scope instrument, never attempted)
...
- `QWS-1011` `epic_10_macro_data[COMPLETE]/story_ndvi_crop_health_collector.md` — `CLOSED` (out-of-scope instrument, never attempted)
...
- `QWS-1303` `epic_agent_design/story_QWS-1303_trial_engineer_agent.md` — `CLOSED` (QWS-1302, QWS-0907)
- `QWS-1304` `epic_agent_design/story_QWS-1304_research_session_command_rewrite.md` — `CLOSED` (QWS-1302, QWS-1303)
