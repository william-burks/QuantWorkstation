...
- `QWS-1005` `epic_10_macro_data[COMPLETE]/story_noaa_degree_days.md` — `TESTING` (out-of-scope instrument, never attempted)
...
Stories (independent — implement in parallel):
- `QWS-1005` `epic_10b_commodity_regime_data/story_QWS-1005_noaa_degree_days.md` — `TESTING`
