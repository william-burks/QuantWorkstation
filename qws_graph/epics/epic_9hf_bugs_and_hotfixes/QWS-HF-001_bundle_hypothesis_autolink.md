...
- type: cli
- cmd: `source .venv/bin/activate && pytest qws_graph/tests/integration/test_cli_record_reconcile.py::TestBundleHypothesisAutolink::test_bundle_with_hypothesis_id_calls_link -v`
- expect_contains: "PASSED"
- expect_exit: 0

### AC2: TESTED_AS created when hypothesis exists
- type: cli
- cmd: `source .venv/bin/activate && pytest qws_graph/tests/integration/test_cli_record_reconcile.py::TestBundleHypothesisAutolink::test_bundle_with_hypothesis_id_calls_link -v`
- expect_contains: "PASSED"
- expect_exit: 0

### AC3: missing hypothesis prints WARNING, ingest succeeds
- type: cli
- cmd: `source .venv/bin/activate && pytest qws_graph/tests/integration/test_cli_record_reconcile.py::TestBundleHypothesisAutolink::test_bundle_hypothesis_not_in_graph_prints_warning -v`
- expect_contains: "PASSED"
- expect_exit: 0

### AC4: dry-run skips TESTED_AS edge
- type: cli
- cmd: `source .venv/bin/activate && pytest qws_graph/tests/integration/test_cli_record_reconcile.py::TestBundleHypothesisAutolink::test_bundle_dry_run_skips_hypothesis_link -v`
- expect_contains: "PASSED"
- expect_exit: 0

### AC5: single-call title + branched-from creates node and edge
- type: cli
- cmd: `source .venv/bin/activate && pytest qws_graph/tests/integration/test_cli_record_reconcile.py::TestHypothesisBranchedFromCombined -v`
