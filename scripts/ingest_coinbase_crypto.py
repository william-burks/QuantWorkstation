...
Usage:
    python scripts/ingest_coinbase_crypto.py
    python scripts/ingest_coinbase_crypto.py --symbols BTC-USD ETH-USD --start 2019-01-01
"""
...
def _load_existing(
    store: Any, arc_sym: str, new_suffix: str, alpaca_suffix: str | None
) -> pd.DataFrame:
