...
Usage:
    python scripts/ingest_sec_insider.py
    python scripts/ingest_sec_insider.py --start 2010-01-01   # partial backfill
"""
...
def _get_form4_filings(
    cik: str, session: requests.Session, start_date: datetime
) -> list[dict[str, Any]]:
