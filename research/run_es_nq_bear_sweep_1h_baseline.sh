#!/usr/bin/env zsh
# ES/NQ Bear Sweep Research — Quick Start Guide
# All commands assume working directory: /Users/will/ClaudeProjects/QuantWorkstation
...
# python strategies/bear_es_sweep_1h_baseline.py --allowed-sessions "NY_PRE,AFTER"
...
# python strategies/bear_nq_sweep_1h_baseline.py --grid \
#   --target-r-grid "1.0,1.25,1.5,1.75" \
#   --wick-modes "none,exclude_q2,q3_q4_only" \
#   --atr-mult-stop-grid "0.3,0.5,0.7" \
#   --allowed-sessions "NY_PRE,AFTER" \
...
echo "2. Update research/es_nq_bear_sweep_tracker.md with results"
...
echo ""
echo "Documentation:"
echo "  - Phase 1 guide: research/es_nq_bear_sweep_phase1_plan.md"
echo "  - Master tracker: research/es_nq_bear_sweep_tracker.md"
